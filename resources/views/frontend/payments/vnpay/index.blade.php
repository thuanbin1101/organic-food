...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="/tryitnow/Styles/js/ie8-responsive-file-warning.js"></script><![endif]-->
...
<div class="container">
    ...
    <div class="table-responsive">
        <form action="{{route('payment.create.vnpay')}}" id="frmCreateOrder" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control" data-val="true" readonly data-val-number="The field Amount must be a number."
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" cols="20" id="OrderDescription" name="order_info" rows="2">
Thanh toan don hang thoi gian: 2023-11-20 22:26:06</textarea>
            </div>
            <div class="form-group">
            ...
            <button type="submit" name="redirect" class="btn btn-default">Thanh toán Redirect</button>
            <a href="{{route('cart.show')}}" class="btn btn-brush">Quay trở lại</a>
            <input type="hidden" value="{{$cart->id}}" name="cart_id">
            <input name="__RequestVerificationToken" type="hidden"
                   value="f1dMYYPvtkbOBtqVb1xVc8NaK90ohX-ebKRqh07BRYRE0eF6KMgvhZmxVwujs6dz2GIxadiwk_I_6rGKaFMgEIaE6qftaoSwpgwo2EuyFDE1"/>
        </form>
    </div>
    <p>
        &nbsp;
